...
// Function para a compactação do arquivo principal 1 (vacinas) AP1.dat
...
void compactarDadosVacina() {
	...
	// Remove o AP1.dat sem compactação e renomeia o AP1 compactado temporário para AP1.dat
